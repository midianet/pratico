var app = angular.module('app', ['ngRoute','angular-table']); //,'ngAnimate']); //,'angular-table',,'ngDialog']);
...
app.controller('moradorCtrl', function($scope,$http,$filter){
    $scope.config = {
        itemsPerPage: 10,
        fillLastPage: true,
        first: 'Primeira',
    ...
    $http.get('/api/morador').success(function(data) {
        $scope.list = data;
    ...
    // }
    //
    // $scope.totalItens = $scope.list.length;
    // $scope.numPerPage = 5;
